...
/*   Updated: 2015/12/15 19:09:11 by chray            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static size_t	ft_size_word(char const *s, size_t start, char c)
{
	size_t	i;
...
static size_t	ft_filltab(char ***tab, char const *s, char c)
{
	size_t	i;
	size_t	j;
